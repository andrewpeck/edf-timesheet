...
(princ
 (format "\n%s\n\n"
         (string-join
          (cl-remove-if-not (lambda (x) (string-search "2023-01" x))
                            (split-string
                             (with-output-to-string
                               (plot-weekly-work-goals-for-date-range 2022 1
                                                                      2023 2))
                             "\n" t)) "\n")))
...
Week 2023-01-01: 109.1% (24 hours) ++++++++++++++++++++++		(2)
...
Week 2022-12-52: 116.7% (28 hours) +++++++++++++++++++++++
#+end_example
