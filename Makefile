...
summary:
	...
	@wordcloud_cli --text wordcloud.txt --imagefile wordcloud.png --background white --colormap "Solarize_Light2" --max_words 50 --width 1024 --height 768 --fontfile "DroidSans" --margin 4 --min_word_length 3
